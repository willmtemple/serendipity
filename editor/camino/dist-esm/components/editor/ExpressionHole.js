...
const ExpressionHole = React.forwardRef((props, ref) => {
    const { ProjectStore } = useStores();
    useResizeParentEffect();
    return (React.createElement("path", { ref: ref, className: "drop " + props.kind, "data-parent-guid": ProjectStore.metadataFor(props.bind).guid, "data-mutation-key": props.bindKey, "data-mutation-idx": props.bindIdx, fill: "#FFFFFFA0", stroke: "#000000", strokeWidth: 1, strokeDasharray: "6 4", d: path }));
});
