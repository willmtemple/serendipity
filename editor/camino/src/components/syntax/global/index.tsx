...
const Global = React.forwardRef<any, { global: EditorGlobal }>((props, ref) => {
  ...
  const body = (() => {
    switch (kind) {
      ...
      case "definefunc":
        return (
          <DefineFunc onDelete={deleteNode} definefunc={glb as surface.global.DefineFunction} />
        );
      default:
        return (
          <g ref={ref}>
  ...
  return (
    <BoundingBox ref={ref} color={getColor(glb)} containerProps={{ id: guid }}>
      {body}
    </BoundingBox>
  );
});
