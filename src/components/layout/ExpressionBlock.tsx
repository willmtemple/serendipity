...
import { IMeasurementProps, IRect, measureChildren } from 'src/hooks/measure';
...
const ExpressionBlock = measureChildren(React.forwardRef<SVGGElement, CompleteProps>((props, ref) => {
